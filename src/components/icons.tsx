...
export function GoogleLogo({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <path
        fill="#4285F4"
        d="M23.52 12.273c0-.851-.076-1.67-.218-2.455H12v4.645h6.458a5.52 5.52 0 01-2.394 3.622v3.01h3.877c2.269-2.09 3.578-5.166 3.578-8.822z"
      />
      <path
        fill="#34A853"
        d="M12 24c3.24 0 5.955-1.075 7.941-2.905l-3.877-3.01c-1.075.72-2.45 1.146-4.064 1.146-3.126 0-5.771-2.111-6.717-4.948H1.28v3.109C3.256 21.302 7.31 24 12 24z"
      />
      <path
        fill="#FBBC05"
        d="M5.283 14.283A7.198 7.198 0 014.909 12c0-.793.136-1.564.374-2.283V6.608H1.28A11.986 11.986 0 000 12c0 1.936.464 3.768 1.28 5.392l4.003-3.109z"
      />
      <path
        fill="#EA4335"
        d="M12 4.77c1.762 0 3.344.606 4.59 1.794l3.442-3.442C17.95 1.19 15.236 0 12 0 7.31 0 3.256 2.698 1.28 6.608l4.003 3.109C6.229 6.881 8.874 4.77 12 4.77z"
      />
    </svg>
  );
}
