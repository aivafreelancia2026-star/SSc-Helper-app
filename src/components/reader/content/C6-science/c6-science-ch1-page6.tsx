    ...
    <div className="w-full space-y-6 font-body text-sm leading-relaxed text-foreground/90">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-4">
          <div className="space-y-3">
            {REFLECTION_QUESTIONS.map((q, i) => (
              <div key={q} className="space-y-1">
                <p className="font-semibold text-foreground/80">• {q}</p>
                <input
                  type="text"
                  value={answers[i]}
                  onChange={(e) => {
          ...
          <h2 className="font-heading text-base font-bold text-primary pt-2">1.3. How people develop food habits?</h2>
          <p>
            ...
            though farmers grow various types of food crops...
          </p>
        </div>
        ...
        <div className="space-y-4 border-t md:border-t-0 md:border-l border-sky-100 pt-6 md:pt-0 md:pl-8">
          <p>
            ...we generally use rice as staple food. A variety of food items are prepared using rice.
          ...
          <h2 className="font-heading text-base font-bold text-primary pt-2">1.4. Different methods of preparing food</h2>
          <p>
