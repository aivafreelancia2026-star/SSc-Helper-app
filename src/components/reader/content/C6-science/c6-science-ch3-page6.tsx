    ...
    <div className="w-full space-y-6 font-body text-sm leading-relaxed text-foreground/90">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-4">
          ...
          <h2 className="font-heading text-base font-bold text-primary pt-2">3.6. Water cycle</h2>
          <p>
          ...
          <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-sky-100 p-4 shadow-sm">
            <img
              src="/assets/images/C6-science/ch3_fig12.png"
              alt="Fig. 12 : Water Cycle"
        ...
        <div className="space-y-4 border-t md:border-t-0 md:border-l border-sky-100 pt-6 md:pt-0 md:pl-8">
          <p>
            ...
            clouds to rain by condensation is known as <strong>&quot;water cycle&quot;</strong>.
          </p>
