...
export function C6ScienceCh2Page6() {
  return (
    <div className="w-full space-y-4 font-body text-sm leading-relaxed text-foreground/90">
      ...
      <h2 className="font-heading text-base font-bold text-primary">2.5. Earth as a Magnet</h2>
      ...
      <h2 className="font-heading text-base font-bold text-primary">Activity-7:</h2>
      <p>
      ...
      <FigureNote emoji="🧲" caption="Fig. 7 — A bar magnet suspended above another bar magnet placed on a table" />

      <p>Change the direction of the bar magnet placed on the table.</p>
      <ul className="list-disc space-y-1.5 pl-5">
        <li>Do you find any change in the direction of suspended bar magnet?</li>
        <li>What is that change?</li>
      </ul>
      ...
      <FigureNote
        emoji="🌍"
        caption="Fig. 8 — Earth acting as a giant bar magnet, with its magnetic south pole near the geographic North"
      />
