...
export function C6HindiCh6Page1() {
  return (
    <div className="flex flex-col w-full max-w-4xl mx-auto bg-slate-50 min-h-screen font-sans shadow-lg pb-12 relative">
      ...
      <div className="absolute right-4 top-4 md:right-8 md:top-8 bg-white p-2 border-2 border-slate-800 flex flex-col items-center shadow-md z-20">
        <div className="w-16 h-16 bg-[url('https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=Y5A3S4')] bg-cover opacity-80 mix-blend-multiply"></div>
        <span className="text-xs font-bold mt-1 tracking-widest text-slate-800">Y5A3S4</span>
      </div>
      ...
      <div className="w-full flex flex-col items-center pt-8 pb-4 relative z-10 px-4">
        ...
        {/* Letters box */}
        <div className="mt-4 mb-6 bg-white border-2 border-teal-600 rounded-full px-8 py-2 shadow-sm">
      ...
      <div className="w-full relative bg-white border-y-4 border-slate-200">
        <div className="relative w-full aspect-[3/4] max-h-[75vh] overflow-hidden group">
          <Image 
            src="/assets/images/C6-hindi/ch6-p1-full.png" 
            alt="चिड़ियाघर" 
            fill
            className="object-contain transition-transform duration-700 group-hover:scale-[1.02]"
            style={{ clipPath: "inset(22% 0 5% 0)" }}
          />
        </div>
      </div>
      ...
      <div className="w-full flex justify-center mt-8 px-4">
        <div className="bg-blue-50 border border-blue-200 p-4 rounded-xl shadow-sm opacity-90 animate-pulse">
          <p className="text-sm text-blue-800 font-bold flex items-center gap-2">
            <span>💡</span>
            चित्र में क्या-क्या दिखाई दे रहा है? दोस्तों के साथ चर्चा करें।
          </p>
        </div>
      </div>
      ...
      <div className="w-full flex items-center justify-between px-8 pt-8 text-sm text-slate-500 font-medium mt-auto">
        ...
        <span className="font-bold text-lg bg-[#dbe8d8] px-4 py-1 rounded text-green-900 border border-[#b8c9b4] shadow-inner">28</span>
